...
const feature_kitchen_1 = __webpack_require__(128);
const feature_tax_1 = __webpack_require__(133);
const feature_user_1 = __webpack_require__(138);
const feature_variant_1 = __webpack_require__(143);
const feature_home_delivery_1 = __webpack_require__(148);
const feature_order_history_1 = __webpack_require__(152);
const feature_kot_1 = __webpack_require__(156);
const feature_license_1 = __webpack_require__(121);
const feature_expense_1 = __webpack_require__(115);
const feature_payment_1 = __webpack_require__(160);
const feature_image_upload_1 = __webpack_require__(165);
...
let ProductService = class ProductService {
    ...
    getProduct() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this.prismaService.product.findMany({
    ...
    createProduct(data) {
        return this.prismaService.product.create({
            data: Object.assign(Object.assign({}, data), { price: +data.price, cost: +data.cost, code: +data.code, collectionId: +data.collectionId, categoryId: +data.categoryId, qwickViewOrder: +data.qwickViewOrder }),
        });
    }
    udpateProduct(id, data) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                return this.prismaService.product.update({
                    where: { id },
                    data: Object.assign(Object.assign({}, data), { price: +data.price, cost: +data.cost, code: +data.code, categoryId: +data.categoryId, qwickViewOrder: +data.qwickViewOrder }),
                });
            }
            catch (error) {
    ...
    updateProductBoolField(id, data) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                const updateData = {};
...
let AuthService = class AuthService {
    ...
    signIn(user) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            console.log('user signed successfully', (_a = response.user) === null || _a === void 0 ? void 0 : _a.username);
            return response;
        });
    }
...
let UserService = class UserService {
    ...
    findOne(username) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const user = yield this.prismaService.user.findFirst({
                where: { username },
            });
...
let JwtStrategy = class JwtStrategy extends (0, passport_1.PassportStrategy)(passport_jwt_1.Strategy) {
    ...
    validate(payload) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            // console.log(payload);
            const user = yield this.authService.getUserFromUserName(payload.username);
            // console.log('inside validate ', user);
            if (!user) {
                throw new common_1.UnauthorizedException();
            }
...
let CategoryService = class CategoryService {
    ...
    getCategory() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this.prismaService.category.findMany({
                include: {
                    kitchen: true,
                },
            });
    ...
    createCategory(data) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const updatedData = Object.assign(Object.assign({}, data), { kitchenId: +data.kitchenId, categoryCode: +data.categoryCode });
            return yield this.prismaService.category.create({
                data: updatedData,
            });
        });
    }
...
let OrderContoller = class OrderContoller {
    ...
    qwickPay(order, req, query) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const paymentDetails = {
                ...
                mode: (_a = query.mode) !== null && _a !== void 0 ? _a : 'cash',
            };
            const newOrder = yield this.orderService.createOrder(order, appUser);
    ...
    acceptHomeDelivery(data, params, req) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const orderId = +params.id;
...
let OrderService = class OrderService {
    ...
    testPrismaggregate(orderID) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const result = yield this.prismaService.orderItem.groupBy({
                by: ['customeKey'],
    ...
    getRecentNotPaidOrders() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            // console.log(dateTimeNowMinus(24));
            // this. shoudl fetch orders of last 24 hours.
            return yield this.prismaService.order.findMany({
                where: {
                    createdAt: {
                        gt: yield this.getActiveSessionStartTime(),
                    },
    ...
    getActiveSessionStartTime() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const activeSession = yield this.prismaService.posSession.findFirst({
                where: {
    ...
    getRecentNotPaidOrdersByUser(user) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            // console.log(dateTimeNowMinus(24));
            // this. shoudl fetch orders of last 24 hours.
            return yield this.prismaService.order.findMany({
    ...
    getOrderDetails(orderId) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            //   },
            // });
            return yield this.prismaService.order.findUnique({
                where: { id: orderId },
                include: {
                    orderItems: {
                        include: {
    ...
    printReceipt(orderId) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const companyId = 1;
                const company = yield this.prismaService.company.findFirst({
                    where: { id: companyId },
                    include: {
                ...
                const order = yield this.prismaService.order.findFirst({
                    where: { id: orderId },
                    include: {
                        orderItems: {
                            include: {
                ...
                const { orderItems, totalCount, totalItems, orderTotal } = yield this.getOrderItemsForTheOrderAggregated(orderId);
                const discountApplied = (_a = order === null || order === void 0 ? void 0 : order.discountApplied) !== null && _a !== void 0 ? _a : 0;
                // const orderTotal = getOrderItemsTotal(orderItems as unknown as OrderItem[]);
                const taxAppliedTotalandInfo = (0, util_1.getAppliedTaxesAndTaxesTotal)(orderTotal, company === null || company === void 0 ? void 0 : company.taxes);
                const totalAfterDiscount = taxAppliedTotalandInfo.taxedTotal - discountApplied;
                // send to the print service.
                const customerNameToPrint = (order === null || order === void 0 ? void 0 : order.orderType) == 'table'
                    ? `${order.customerName} `
                    : (_b = order === null || order === void 0 ? void 0 : order.customer) === null || _b === void 0 ? void 0 : _b.firstName;
                const customerLastNameToPrint = ((_c = order === null || order === void 0 ? void 0 : order.customer) === null || _c === void 0 ? void 0 : _c.lastName)
                    ? order.customer.lastName
                    : '';
                const noOfDecimalPlaces = (company === null || company === void 0 ? void 0 : company.decimalZeros)
                    ? company.decimalZeros
                    : 3;
                const mappedOrderItems = orderItems.map((orderItem) => {
                    return Object.assign(Object.assign({}, orderItem), { amount: orderItem.amount.toFixed(noOfDecimalPlaces), otherLanguageName: orderItem.product.secondaryLanguageName, individualTotal: (orderItem.count * orderItem.amount).toFixed(noOfDecimalPlaces) });
                });
                const billType = this.getBillTypeFromOrder(order);
                const isHomeDelivery = (order === null || order === void 0 ? void 0 : order.orderType) == types_1.OrderType.HOMEDELIVERY;
                const homeDeliveryUserName = (_d = order === null || order === void 0 ? void 0 : order.deliveryUser) === null || _d === void 0 ? void 0 : _d.name;
                // console.log(mappedOrderItems.length);
                const infoToPrint = {
                    companyName: company === null || company === void 0 ? void 0 : company.name,
                    address: (company === null || company === void 0 ? void 0 : company.address) ? company === null || company === void 0 ? void 0 : company.address : '****',
                    billDateTime: (0, util_1.dateTimeToDateHHMM)(order.createdAt),
                    billType,
                    orderNumber: `Order No- ${order === null || order === void 0 ? void 0 : order.orderNumber}`,
                    paymentStatus: (order === null || order === void 0 ? void 0 : order.paymentStatus) == 'paid' ? '( PAID )' : '(NOT PAID  )',
                    orderTypeTitle: (order === null || order === void 0 ? void 0 : order.orderType) == 'table' ? 'Table Info' : 'Customer Info',
                    customerName: customerNameToPrint,
                    lastName: customerLastNameToPrint,
                    waiterName: order === null || order === void 0 ? void 0 : order.user.name,
                    isHomeDelivery,
                    homeDeliveryUserName,
                    orderItems: mappedOrderItems,
                    total: orderTotal.toFixed(noOfDecimalPlaces),
                    appliedTaxesInfo: taxAppliedTotalandInfo.taxesApplied.map((item) => (Object.assign(Object.assign({}, item), { value: item.value.toFixed(noOfDecimalPlaces) }))),
                ...
                if (this.thermalPrintConfig.shouldUseThermalPrinter) {
                    ...
                    yield this.pdfService.printReceipt(infoToPrint, printer);
                }
                return order;
    ...
    getNextOrderNumber() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                ...
                yield this.waitTillFromArray();
                const company = yield this.prismaService.company.findFirst();
                if (!company)
                    throw new Error('no company data found');
                // console.log('oriingal order number', company.lastOrderNumber);
                const updatedCompanyDetails = yield this.prismaService.company.update({
                    where: {
                        id: company === null || company === void 0 ? void 0 : company.id,
                    },
                    data: {
                        lastOrderNumber: (company === null || company === void 0 ? void 0 : company.lastOrderNumber) + 1,
                    },
                });
                // console.log(
                ...
                // );
                return updatedCompanyDetails === null || updatedCompanyDetails === void 0 ? void 0 : updatedCompanyDetails.lastOrderNumber;
            }
            catch (error) {
    ...
    isAllowedToCreateOrder() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                const activeSessions = yield this.prismaService.posSession.findFirst({
    ...
    createOrder(createOrderDto, appUser) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const isAllowedToCreateOrder = yield this.isAllowedToCreateOrder();
            ...
            try {
                ...
                if (createOrderDto.customerId) {
                    ...
                    const existingOrder = yield this.checkIfCustomerHasRunningOrder(customerId);
                    if (!existingOrder)
                        throw new Error();
                    yield this.updateOrderItemsTable(existingOrder, createOrderDto, true, appUser, printKot);
                    return existingOrder;
                }
                else {
                    if (createOrderDto.cartCreatedFor.userType == types_1.UserType.HOMEDELIVERY) {
                        const newOrder = yield this.createHomeDeliveryOrder(createOrderDto, appUser);
                        if (!newOrder)
                            throw new common_1.BadRequestException('could not create any new order..');
                        // console.log('order has been created.', newOrder);
                        yield this.updateOrderItemsTable(newOrder, createOrderDto, false, appUser, printKot);
                        return newOrder;
                    }
                    else if (createOrderDto.cartCreatedFor.userType == types_1.UserType.TAKEAWAY) {
                        const newOrder = yield this.createTakeAwayOrder(createOrderDto, appUser);
                        if (!newOrder)
                            throw new common_1.BadRequestException('could not create any new order..');
                        // console.log('order has been created.', newOrder);
                        yield this.updateOrderItemsTable(newOrder, createOrderDto, false, appUser, printKot);
                        ...
                        const newOrder = yield this.createTableOrder(createOrderDto, appUser);
                        yield this.updateOrderItemsTable(newOrder, createOrderDto, false, appUser, printKot);
                        return newOrder;
                    }
                }
    ...
    createTakeAwayOrder(createOrderDto, appUser) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                const nextOrderId = yield this.getNextOrderNumber();
                // console.log('order id now is', nextOrderId);
                const newCustomer = yield this.prismaService.customer.create({
                    data: {
                ...
                const newOrder = yield this.prismaService.order.create({
                    data: {
    ...
    createHomeDeliveryOrder(createOrderDto, appUser) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                const nextOrderId = yield this.getNextOrderNumber();
                // console.log('order id now is', nextOrderId);
    ...
    updateOrderItemsTable(order, createOrderDto, isRunning, appUser, printKot) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const categories = yield this.prismaService.category.findMany({
                    select: {
                        id: true,
                        kitchen: true,
                    },
                ...
                orderItems1.forEach((orderItem) => {
                    ...
                    const kitchenDetail = (_a = categories.find((cat) => cat.id === catId)) === null || _a === void 0 ? void 0 : _a.kitchen;
                    kitchenTempArra.push(kitchenDetail);
                    const kitId = (_b = kitchenDetail === null || kitchenDetail === void 0 ? void 0 : kitchenDetail.id) !== null && _b !== void 0 ? _b : 'noPrinter';
                ...
                yield Promise.all(Object.entries(kitchenIdVice).map((_a) => tslib_1.__awaiter(this, [_a], void 0, function* ([kitId, resultantCartItems]) {
                    var _b;
                    const kotCreated = yield this.prismaService.kot.create({
                        data: {
                            kitchenId: +kitId,
                            updatedUserId: appUser.id,
                            orderId: order.id,
                            note: (_b = createOrderDto.note) !== null && _b !== void 0 ? _b : '',
                            ...
                            orderItems: {
                                create: resultantCartItems.map((resultantCartItem) => {
                                    ...
                                    const orderItem = {
                                        ...
                                        customeKey: (_a = resultantCartItem.key) !== null && _a !== void 0 ? _a : '',
                                        ...
                                        note: (_b = resultantCartItem.note) !== null && _b !== void 0 ? _b : '',
                                        modifiers: resultantCartItem.modifiers
                                            ? (_c = resultantCartItem.modifiers) === null || _c === void 0 ? void 0 : _c.reduce((prev, curr) => prev.concat(curr.name, ', '), '')
                                            : '',
                                    };
                                    return orderItem;
                                }),
    ...
    createKOTData(kot, order, user, hasDeleteItems, hasEditItems, isRunningOrder) {
        ...
        const kotTotalToFixed3 = (_a = kot.orderItems
            .reduce((prev, item) => prev + (item.count > 0 ? item.count : 0) * item.amount, 0)
            .toFixed(3)) !== null && _a !== void 0 ? _a : '';
        const updatedData = {
            ...
            orderNumber: `Order No- ${order === null || order === void 0 ? void 0 : order.orderNumber}`,
            orderTypeTitle: (order === null || order === void 0 ? void 0 : order.orderType) == 'table' ? 'Table Info' : 'Customer Info',
            kotType: (order === null || order === void 0 ? void 0 : order.orderType) == 'table' ? 'Dine In' : 'Take Away',
            isRunningOrder,
            ...
            numberOfItems: (_b = kot.orderItems.length.toString()) !== null && _b !== void 0 ? _b : '',
            kotNote: (_c = kot.note) !== null && _c !== void 0 ? _c : '',
            kotTotalAmount: kotTotalToFixed3,
            quantity: (_d = kot.orderItems
                .reduce((prev, item) => prev + (item.count > 0 ? item.count : 0), 0)
                .toString()) !== null && _d !== void 0 ? _d : '',
        };
        return updatedData;
    }
    ...
    checkIfCustomerHasRunningOrder(customerId) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                const existingOrderFortheTable = yield this.prismaService.order.findFirst({
                    where: {
    ...
    createTableOrder(createOrderDto, appUser) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                const tableId = createOrderDto.tableId;
                const nextOrderId = yield this.getNextOrderNumber();
    ...
    makeBillForTheOrder(orderId) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            // check if the order is in in progress status. no need as front end takes care of it.
            try {
                const updatedOrder = yield this.prismaService.order.update({
                    where: { id: orderId },
                    data: {
    ...
    payTheBill(orderId, shouldPrintBill, paymentDetails) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            // check if the order is in in progress status. no need as front end takes care of it.
            ...
            try {
                const updatedOrder = yield this.prismaService.order.update({
                    where: { id: orderId },
                    data: Object.assign({ paymentStatus: types_1.PaymentStatus.PAID, orderStatus: types_1.OrderStatus.SERVED }, (paymentDetails.paidAmount && {
    ...
    cancelTheBill(orderId, shouldPrintBill) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            // check if the order is in in progress status. no need as front end takes care of it.
            try {
                const updatedOrder = yield this.prismaService.order.update({
    ...
    creditSettle(orderId, shouldPrintBill) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            // check if the order is in in progress status. no need as front end takes care of it.
            try {
                const updatedOrder = yield this.prismaService.order.update({
    ...
    getOrderItemsForTheOrderAggregated(orderId) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            let totalItems = 0;
            let totalCount = 0;
            let orderTotal = 0;
            ...
            const uniqeOrderItems = yield this.prismaService.orderItem.findMany({
                where: { orderId },
                distinct: ['customeKey'],
            });
            ...
            const aggregatedOrderItems = yield Promise.all(mappedWithResult.map((item) => tslib_1.__awaiter(this, void 0, void 0, function* () {
                const dbItem = yield this.prismaService.orderItem.findFirst({
                    where: { customeKey: item.customeKey, orderId },
                    include: { product: true },
                });
                const updateOrderItemWithCount = Object.assign(Object.assign({}, dbItem), { count: item._sum.count });
            ...
            const filtedItems = aggregatedOrderItems.filter((item) => (item === null || item === void 0 ? void 0 : item.count) != 0);
            const agregated = {
    ...
    updateOrderItemsForTheOrder(orderId, orderItems) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
    ...
    getOpenHomeDeliveryOrders() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                const openDeliveryOrders = yield this.prismaService.order.findMany({
                    where: {
                        deliveryUserId: null,
                        orderType: types_1.OrderType.HOMEDELIVERY,
                        orderStatus: { not: types_1.OrderStatus.CANCELLED },
                        createdAt: { gte: yield this.getActiveSessionStartTime() },
                    },
                    include: { customer: true, user: true },
                });
    ...
    acceptHomeDeliveryOrder(orderId, deliveryUserId) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                const updatedOrder = yield this.prismaService.order.update({
                    where: { id: orderId },
...
let PDFService = class PDFService {
    ...
    printReceipt(receiptData, printerName) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            yield this.savePdf(html, pdfOptions);
            yield this.printService.printPdfAtPath(pdfOptions.path, printerName);
    ...
    printKot(kotData) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            yield this.savePdf(html, pdfOptions);
            yield this.printService.printPdfAtPath(pdfOptions.path, kotData.printer);
            yield this.deletePdf(pdfOptions.path);
        });
    }
    ...
    savePdf(html, options) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const height = yield page.evaluate(() => document.documentElement.offsetHeight);
            ...
            yield page.pdf(Object.assign(Object.assign({}, options), { height: extrapaddedHeight + 'px', printBackground: true }));
            yield browser.close();
        });
    }
    deletePdf(path) {
...
let PrintService = class PrintService {
    printPdfAtPath(pPath, printerName) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const result = yield this.printDoc((0, pdf_to_printer_1.print)((0, path_1.resolve)(__dirname, pPath), {
    ...
    printDoc(asyncPromise, timeLimit) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            let timeoutHandle;
            ...
            puppeteer_service_1.PuppeteerService,
            {
                ...
                useFactory: (configService) => {
                    ...
                    const thermalSetup = {
                        ...
                        printerBeepOption1: (_a = configService.get('thermal_beep_count_option1')) !== null && _a !== void 0 ? _a : 1,
                        printerBeepOption2: (_b = configService.get('thermal_beep_count_option2')) !== null && _b !== void 0 ? _b : 1,
                    };
                    return thermalSetup;
                },
...
let PuppeteerService = class PuppeteerService {
    getReportPdfStream(reportName, templatefolderName, outputFolderName, htmlName, inputData) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            // setup the html page.
            const html = (0, puppeteer_util_1.createHtmlDoc)(htmlName, inputData, templatefolderName);
            // setup pdf options.
            const pdfOptions = (0, puppeteer_util_1.getPdfOptionsForSummaryReport)(outputFolderName, reportName);
            return this.getPdfStream(html, pdfOptions);
        });
    }
    getPdfStream(html, options) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const browser = yield (0, puppeteer_util_1.createBrowser)();
            const page = yield (0, puppeteer_util_1.setupHtmlPage)(html, browser);
            const extrapaddedHeight = yield (0, puppeteer_util_1.getPaddedDocHeight)(100, page);
            // to get only the buffer delete path from the pdfoptions\
            const udpatedPdfOptions = Object.assign(Object.assign({}, options), { height: extrapaddedHeight + 'px', printBackground: true });
            delete udpatedPdfOptions['path'];
            const pdfBuffer = yield page.pdf(udpatedPdfOptions);
            yield browser.close();
            return pdfBuffer;
        });
    }
    savePdf(html, options) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            yield page.pdf(Object.assign(Object.assign({}, options), { height: extrapaddedHeight + 'px' }));
            yield browser.close();
        });
    }
    getPdfOptions(folderName, name) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.getPaddedDocHeight = exports.setupHtmlPage = exports.createBrowser = exports.createHtmlDoc = exports.createPdfPath = exports.getPdfOptionsForReciept = exports.getPdfOptionsForSummaryReport = exports.deletePdf = void 0;
const tslib_1 = __webpack_require__(1);
const fs_1 = __webpack_require__(77);
const path_1 = __webpack_require__(79);
const puppeteer_1 = __webpack_require__(80);
...
const getPdfOptionsForSummaryReport = (folderName, name) => {
...
exports.getPdfOptionsForSummaryReport = getPdfOptionsForSummaryReport;
...
const createBrowser = () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    const browser = yield (0, puppeteer_1.launch)({
        args: [
            '--no-sandbox',
            '--disable-features=IsolateOrigins',
...
const setupHtmlPage = (html, browser) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    const page = yield browser.newPage();
    // await page.goto(`data:text/html;charset=UTF-8,${html}`, {
    //   waitUntil: 'networkidle0',
    // });
...
const getPaddedDocHeight = (padding, page) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    const height = yield page.evaluate(() => document.documentElement.offsetHeight);
    // console.log('page goto method..', await page.content());
    // height auto was the right fix for the page cut of pdf
    // generated for longer bill.
...
let CompanyService = class CompanyService {
    ...
    updateCompany(updateCompanyDto) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            return yield this.prismaService.company.update({
                ...
                data: Object.assign(Object.assign({}, updateCompanyDto), { lastOrderNumber: +updateCompanyDto.lastOrderNumber, decimalZeros: +updateCompanyDto.decimalZeros }),
            });
        });
    }
    ...
    updateProductShortcuts(updateProductShorcutdto, shortcutType) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                const company = yield this.prismaService.company.update({
                    where: { id: updateProductShorcutdto.id },
                    data: Object.assign(Object.assign({}, (shortcutType == types_1.CompanyShortcutTypes.PRODUCTSHORTCUTS && {
...
let TableService = class TableService {
    ...
    getTables() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this.prismaService.table.findMany({
                include: {
                    tableSeats: true,
                    orders: {
                        where: {
    ...
    createTable(data) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                return yield this.prismaService.table.create({
...
let FloorService = class FloorService {
    ...
    getFloors() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this.prismaService.floor.findMany();
        });
    }
    getFloorTables(floorId) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this.prismaService.floor.findFirst({
                where: { id: floorId },
                select: {
                    id: true,
                    tables: {
    ...
    createFloor(floor) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                return yield this.prismaService.floor.create({
                    data: {
                        name: floor.name,
                    },
                });
    ...
    editFloor(id, floor) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                return yield this.prismaService.floor.update({
                    where: { id },
                    data: {
                        name: floor.name,
                    },
...
let PosSessionController = class PosSessionController {
    constructor(sessionService, sessionReportService, chaviService) {
    ...
    // @Response({ passthrough: true }) res: any
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const closedSession = yield this.sessionService.closeSession(sessionId);
    ...
    // @UseGuards(JwtAuthGuard)
    downloadSessionReport(req, Id, res) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const sessionId = +Id;
            // const user = req.user;se
            const result = yield this.sessionReportService.downloadSessionReport(sessionId);
            res.set({
                'Content-Type': 'application/pdf',
                'Content-Disposition': `attachment; filename="${result === null || result === void 0 ? void 0 : result.reportName}.pdf`,
            });
            return new common_1.StreamableFile(result.pdfStream);
        });
    }
    downloadHomedeliveryReportOfLastSession(req, Id, res) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const result = yield this.sessionReportService.getHomedeliverySummaryOfLastSession();
            // const result = await this.sessionReportService.downloadSessionReport();
            // res.set({
            //   'Content-Type': 'application/pdf',
            //   'Content-Disposition': `attachment; filename="${result?.reportName}.pdf`,
...
exports.PosSessionController = PosSessionController = tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:paramtypes", [typeof (_a = typeof session_service_1.PosSessionService !== "undefined" && session_service_1.PosSessionService) === "function" ? _a : Object, typeof (_b = typeof report_service_1.SessionReportService !== "undefined" && report_service_1.SessionReportService) === "function" ? _b : Object, typeof (_c = typeof feature_license_1.ChaviService !== "undefined" && feature_license_1.ChaviService) === "function" ? _c : Object])
...
let PosSessionService = class PosSessionService {
    ...
    createSession(appUser, initialCash) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                ...
                yield this.prismaService.posSession.create({
                    data: {
                        status: types_1.SessionStatus.ACTIVE,
                        createdUserId: appUser.id,
    ...
    getSessions() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const sessions = yield this.prismaService.posSession.findMany({
                where: {
                    OR: [
                        {
                            status: types_1.SessionStatus.ACTIVE,
    ...
    closeSession(sessionId) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const activeSession = yield this.prismaService.posSession.findUnique({
                where: { id: sessionId },
            });
            if (!activeSession)
                throw new common_1.NotFoundException('No active session');
            const activeSessionStartTime = activeSession.startTime;
            const nonPaidOrders = yield this.prismaService.order.findMany({
                where: {
                    paymentStatus: { notIn: [types_1.PaymentStatus.CREDIT, types_1.PaymentStatus.PAID] },
                    orderStatus: { not: types_1.OrderStatus.CANCELLED },
            ...
            const closedSession = yield this.prismaService.posSession.update({
                where: { id: sessionId },
...
let SessionReportService = class SessionReportService {
    ...
    downloadSessionReport(sessionId) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const session = yield this.getSessionDetails(sessionId);
                // get company taxes.
                const company = yield this.prismaService.company.findFirst({
                    include: { taxes: true },
                });
                ...
                const reportSummary = yield this.statService.getReportStatsForThePeriod(startTime, endTime);
                const paymentBreakDownSummary = yield this.statService.getPayementBreakDownForThePeriod(startTime, endTime);
                ...
                const prductSummary = yield this.statService.getProductStatsForThePeriod(startTime, endTime);
                const staffCountSummary = yield this.statService.getStaffCountStatsForThePeriod(startTime, endTime);
                const staffAmoutSummary = yield this.statService.getStaffAmountStatsForThePeriod(startTime, endTime);
                // console.log('statff amount, ', staffAmoutSummary);
                const homeDeliveryCountSummary = yield this.statService.getHomeDeliveryStatCountViceForThePeriod(startTime, endTime);
                // console.log('home delivery count', homeDeliveryCountSummary);
                const homeDeliveryAmoutSummary = yield this.statService.getHomeDeliveryStatAmountViceForThePeriod(startTime, endTime);
                ...
                // include expense
                const { expensePaidFromCash, totalExpense, filteredExpenseList } = yield this.getExpenseDetails(noOfDecimalPlaces, startTime, endTime);
                ...
                const htmlInputData = {
                    ...
                    paymentBreakDownArr: paymentBreakDownSummary.length
                        ? paymentBreakDownSummary.map((item) => (Object.assign(Object.assign({}, item), { total: item.total.toFixed(noOfDecimalPlaces) })))
                        : [],
                    totalExpense,
                    filteredExpenseList,
                    ...
                    stafAmoutStatArr: staffAmoutSummary.length
                        ? staffAmoutSummary.map((item) => (Object.assign(Object.assign({}, item), { totalusersalesum: item.totalusersalesum.toFixed(noOfDecimalPlaces) })))
                        : [],
                    ...
                    homeDeliveryAmoutStatArr: homeDeliveryAmoutSummary.length
                        ? homeDeliveryAmoutSummary.map((item) => (Object.assign(Object.assign({}, item), { totalusersalesum: item.totalusersalesum.toFixed(noOfDecimalPlaces) })))
                        : [],
                    paymentBreakDownSummary: paymentBreakDownSummary.length
                        ? paymentBreakDownSummary.map((item) => (Object.assign(Object.assign({}, item), { total: item.total.toFixed(noOfDecimalPlaces) })))
                        : [],
                };
                const pdfStream = yield this.pupeteerService.getReportPdfStream('sessionSummary', 'views', 'pdf', 'sessionEndsummary.report.html', htmlInputData);
                return {
                    pdfStream,
    ...
    getSessionDetails(sessionId) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this.prismaService.posSession.findUnique({
                where: { id: sessionId },
            });
        });
    }
    ...
    getExpenseDetails(decimalPlaces, startTime, endTime) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            let expensePaidFromCash = 0;
            let totalExpense = 0;
            const expensenList = yield this.expenseService.getExpensesCreatedForDuration(startTime, endTime);
            const filteredExpenseList = expensenList
                .filter((expense) => expense.expenses.length > 0)
                .map((expenseTypeList) => {
                return Object.assign(Object.assign({}, expenseTypeList), { expenses: expenseTypeList.expenses.map((expense) => {
                        if (expense.paidFromCash) {
                            expensePaidFromCash = expensePaidFromCash + expense.amount;
                        }
                        totalExpense = totalExpense + expense.amount;
                        return Object.assign(Object.assign({}, expense), { amount: expense.amount.toFixed(decimalPlaces) });
                    }) });
            });
    ...
    getHomedeliverySummaryOfLastSession() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                const companyId = 1;
                const company = yield this.prismaService.company.findFirst({
                ...
                const noOfDecimalPlaces = (company === null || company === void 0 ? void 0 : company.decimalZeros)
                    ? company.decimalZeros
                    : 3;
                const homeDeliveryOfTheCurrentSessionByDeliveryUsers = (yield this
    ...
    `);
                const mappedNullsTo9999 = homeDeliveryOfTheCurrentSessionByDeliveryUsers.map((item) => (Object.assign(Object.assign({}, item), { name: item.name ? item.name : 'Not Assigned', total: Number.parseFloat(item.total).toFixed(noOfDecimalPlaces), deliveryUserId: item.deliveryUserId ? item.deliveryUserId : 9999 })));
                const resultObj = {};
                mappedNullsTo9999.forEach((item) => {
                    ...
                    resultObj[itemDeliveryUserId] = [
                        ...(resultObj[itemDeliveryUserId] || []),
                        ...[
                            Object.assign(Object.assign({}, item), { createdAt: (0, util_1.dateTimeToDateHHMM)(new Date(item.createdAt)) }),
                        ],
                    ];
                });
                ...
                Object.keys(resultObj).forEach((key) => (resultTotalObj[key] = Object.assign(Object.assign({}, resultTotalObj[key]), { orders: resultObj[key] })));
                const htmlInputData = this.createHomeDeliveryReportData(resultTotalObj);
                const pdfStream = yield this.pupeteerService.getReportPdfStream('homedelivery', 'views', 'pdf', 'homedliveryorderwisebreakdown.html', htmlInputData);
                return {
                    pdfStream,
...
let StatsService = class StatsService {
    ...
    getProductStatsForThePeriod(startDateTime, endDateTime) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const startTimeISO = startDateTime.toISOString();
            const endTimeISO = endDateTime.toISOString();
            const productStatArr = yield this.prismaService.$queryRaw `
...
(
    ...
    getReportStatsForThePeriod(startDateTime, endDateTime) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            console.log('start dateTime', startDateTime);
            console.log('end dateTime', endDateTime);
            const startTimeISO = startDateTime.toISOString();
            const endTimeISO = endDateTime.toISOString();
            const orderStatArr = yield this.prismaService
    ...
    getPayementBreakDownForThePeriod(startDateTime, endDateTime) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const startTimeISO = startDateTime.toISOString();
            const endTimeISO = endDateTime.toISOString();
            const paymentBreakDownArray = yield this.prismaService.$queryRaw `
    ...
    getStaffCountStatsForThePeriod(startDateTime, endDateTime) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const startTimeISO = startDateTime.toISOString();
            const endTimeISO = endDateTime.toISOString();
            const staffStatArr = yield this.prismaService.$queryRaw `
    ...
    getStaffAmountStatsForThePeriod(startDateTime, endDateTime) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const startTimeISO = startDateTime.toISOString();
            const endTimeISO = endDateTime.toISOString();
            const staffStatArr = yield this.prismaService.$queryRaw `
  ...
  order by totalusersalesum desc
    ...
    getHomeDeliveryStatCountViceForThePeriod(startDateTime, endDateTime) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const startTimeISO = startDateTime.toISOString();
            const endTimeISO = endDateTime.toISOString();
            const homeDeliverStatArr = yield this.prismaService.$queryRaw `
 ...
 (select orderT."deliveryUserId" as deliveryUserID, count(orderT.id) as orderCount from public."order" orderT 
  ...
  order by orderCount desc
    ...
    getHomeDeliveryStatAmountViceForThePeriod(startDateTime, endDateTime) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const startTimeISO = startDateTime.toISOString();
            const endTimeISO = endDateTime.toISOString();
            const homeDeliverStatArr = yield this.prismaService.$queryRaw `
  ...
  order by totalusersalesum desc
    ...
    getDashBoardData() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            // get the start date.
            const sessionStartTime = yield this.getActiveSessionStartTime();
            ...
            const saleStatTypeBased = yield this.prismaService.$queryRaw `
    ...
    group by orderTFiltered."orderType"`;
            ...
            const saleStatTypeCount = yield this.prismaService.$queryRaw `
...
let ExpenseService = class ExpenseService {
    ...
    createExpenseType(data) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                const createdExpenseType = yield this.prismaService.expenseType.create({
                    data,
                });
    ...
    addExpense(data) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                const addedExpense = yield this.prismaService.expense.create({
                    data,
                });
                return addedExpense;
            }
    ...
    getExpenseTypes() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this.prismaService.expenseType.findMany();
        });
    }
    getExpensesCreatedCurrentSession() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            // get current session start date.
            const currentSession = yield this.prismaService.posSession.findFirst({
                where: {
                    status: types_1.SessionStatus.ACTIVE,
                },
            });
            const currentSessionStartDateTime = currentSession === null || currentSession === void 0 ? void 0 : currentSession.startTime;
            // query for expense created in the current session
            const expenseTypeListOfTheSession = yield this.prismaService.expenseType.findMany({
                include: {
                    expenses: {
    ...
    getExpensesCreatedForDuration(startDate, endDate) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const expenseTypeListOfTheSession = yield this.prismaService.expenseType.findMany({
                include: {
                    expenses: {
...
exports.FeatureLicenseModule = FeatureLicenseModule = tslib_1.__decorate([
    (0, common_1.Module)({
        controllers: [],
        providers: [license_service_1.ChaviService],
        exports: [license_service_1.ChaviService],
        imports: [schedule_1.ScheduleModule.forRoot(), jwt_1.JwtModule],
    }),
    tslib_1.__metadata("design:paramtypes", [typeof (_a = typeof license_service_1.ChaviService !== "undefined" && license_service_1.ChaviService) === "function" ? _a : Object])
...
var _a;
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.ChaviService = void 0;
const tslib_1 = __webpack_require__(1);
const common_1 = __webpack_require__(2);
const schedule_1 = __webpack_require__(123);
const jwt_1 = __webpack_require__(18);
const regedit_rs_1 = __webpack_require__(125);
const child_process_1 = __webpack_require__(126);
const crypto_1 = __webpack_require__(127);
...
let ChaviService = ChaviService_1 = class ChaviService {
    constructor(jwtService) {
        this.jwtService = jwtService;
        this.logger = new common_1.Logger(ChaviService_1.name);
    }
    // @Cron('45 * * * * *')
    handleCron() {
    ...
    getRegistryKey(paths, key) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const result = yield (0, regedit_rs_1.list)(paths);
    ...
    getCurrentMachineId() {
        try {
            ...
            const mbSerial = (0, child_process_1.execSync)('powershell "Get-CimInstance -ClassName Win32_BaseBoard | Select-Object -ExpandProperty SerialNumber"', { encoding: 'utf8' }).trim();
            // Get CPU ID
            const cpuId = (0, child_process_1.execSync)('powershell "Get-CimInstance -ClassName Win32_Processor | Select-Object -ExpandProperty ProcessorId | Select-Object -First 1"', { encoding: 'utf8' }).trim();
            // Get BIOS Serial
            const biosSerial = (0, child_process_1.execSync)('powershell "Get-CimInstance -ClassName Win32_BIOS | Select-Object -ExpandProperty SerialNumber"', { encoding: 'utf8' }).trim();
            // Combine and hash
    ...
    chaviKandethuka(registryKey, envKey, machineId) {
        ...
        const registryEncryptionKey = (0, crypto_1.scryptSync)(machineId, Buffer.from(''), 32);
        let registryDecipher;
        try {
            registryDecipher = (0, crypto_1.createDecipheriv)(ALGORITHM, registryEncryptionKey, registryIv);
        ...
        const envEncryptionKey = (0, crypto_1.scryptSync)(JSON.stringify(registryPayload), Buffer.from(''), 32);
        let envDecipher;
        try {
            envDecipher = (0, crypto_1.createDecipheriv)(ALGORITHM, envEncryptionKey, envIv);
...
exports.ChaviService = ChaviService;
tslib_1.__decorate([
    (0, schedule_1.Cron)('0 10,17 * * *') // at 10 AM and 5 PM everyday
    ,
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", []),
    tslib_1.__metadata("design:returntype", void 0)
], ChaviService.prototype, "handleCron", null);
exports.ChaviService = ChaviService = ChaviService_1 = tslib_1.__decorate([
    (0, common_1.Injectable)(),
...
const tslib_1 = __webpack_require__(1);
const common_1 = __webpack_require__(2);
const kitchen_service_1 = __webpack_require__(130);
const data_access_db_1 = __webpack_require__(7);
const kitchen_controller_1 = __webpack_require__(131);
...
let KitchenService = class KitchenService {
    ...
    createKitchen(kitchen) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this.prismaService.kitchen.create({
                data: {
                    name: kitchen.name,
    ...
    getKitchens() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this.prismaService.kitchen.findMany();
        });
    }
...
const common_1 = __webpack_require__(2);
const kitchen_service_1 = __webpack_require__(130);
const create_kitchen_dto_1 = __webpack_require__(132);
...
const tslib_1 = __webpack_require__(1);
const common_1 = __webpack_require__(2);
const tax_controller_1 = __webpack_require__(135);
const tax_service_1 = __webpack_require__(136);
const data_access_db_1 = __webpack_require__(7);
...
const common_1 = __webpack_require__(2);
const tax_service_1 = __webpack_require__(136);
const create_tax_dto_1 = __webpack_require__(137);
...
let TaxService = class TaxService {
    ...
    createTax(tax) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                return yield this.prismaService.tax.create({
                    data: {
                        name: tax.name,
    ...
    updateTax(id, tax) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                return yield this.prismaService.tax.update({
                    where: { id },
                    data: {
                        name: tax.name,
                        printName: tax.printName,
...
const tslib_1 = __webpack_require__(1);
const common_1 = __webpack_require__(2);
const user_controller_1 = __webpack_require__(140);
const user_service_1 = __webpack_require__(141);
const data_access_db_1 = __webpack_require__(7);
...
const common_1 = __webpack_require__(2);
const user_service_1 = __webpack_require__(141);
const user_create_dto_1 = __webpack_require__(142);
...
let UserService = class UserService {
    ...
    getUsers() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                return yield this.prismaService.user.findMany();
            }
            catch (error) {
                throw new common_1.BadRequestException({ error: error });
            }
...
const data_access_db_1 = __webpack_require__(7);
const common_1 = __webpack_require__(2);
const variant_service_1 = __webpack_require__(145);
const variant_conroller_1 = __webpack_require__(146);
...
let VariantService = class VariantService {
    ...
    getVariants(productId) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this.prismaService.variant.findMany({
                where: {
                    productId: productId,
                },
            });
    ...
    createVariant(productId, createVariantDto) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                const variant = yield this.prismaService.variant.create({
                    data: {
    ...
    updateVariant(variantId, updateVariantDto) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                const variant = yield this.prismaService.variant.update({
                    where: { id: variantId },
                    data: {
    ...
    deleteVariant(variantId) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                const variant = yield this.prismaService.variant.delete({
                    where: { id: variantId },
                });
                return variant;
            }
...
const common_1 = __webpack_require__(2);
const variant_service_1 = __webpack_require__(145);
const create_variant_dto_1 = __webpack_require__(147);
...
const data_access_db_1 = __webpack_require__(7);
const common_1 = __webpack_require__(2);
const home_delivery_controller_1 = __webpack_require__(150);
const home_delivery_service_1 = __webpack_require__(151);
const feature_auth_1 = __webpack_require__(15);
...
let HomeDeliveryService = class HomeDeliveryService {
    ...
    deliverHomeDeliveryOrder(orderId) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            // console.log('delivering home order.', orderId);
            try {
                yield this.prismaService.order.update({
                    where: { id: orderId },
                    data: {
                        orderStatus: types_1.OrderStatus.DELIVERED,
                    },
    ...
    getNonClosedHomeDeliveryOrdersOfTheCurrentSession(user) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            try {
                return yield this.prismaService.order.findMany({
                    where: Object.assign({ createdAt: { gte: yield this.getActiveSessionStartTime() }, orderType: types_1.OrderType.HOMEDELIVERY, orderStatus: {
                            notIn: [types_1.OrderStatus.DELIVERED, types_1.OrderStatus.CANCELLED],
                        }, deliveryUserId: { not: null } }, (user.isHomeDeliveryUser && { deliveryUserId: user.id })),
                    include: { customer: true, user: true },
                });
            }
            catch (error) {
    ...
    getClosedHomeDeliveryOrdersOfTheCurrentSession(user) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            // if cashier get all orders.
            // if deliver user get only assinged.
            // const isUserHasOnlyHomeDeliveryAccess =
            ...
            try {
                return yield this.prismaService.order.findMany({
                    where: Object.assign({ createdAt: { gte: yield this.getActiveSessionStartTime() }, orderType: types_1.OrderType.HOMEDELIVERY, orderStatus: types_1.OrderStatus.DELIVERED, deliveryUserId: { not: null } }, (user.isHomeDeliveryUser && { deliveryUserId: user.id })),
                    include: { customer: true, user: true },
                });
            }
            catch (error) {
    ...
    getHomeDeliveryOrdersOfTheCurrentSession(user) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            // if cashier get all orders.
            // if deliver user get only assinged.
            // const isUserHasOnlyHomeDeliveryAccess =
            ...
            try {
                return yield this.prismaService.order.findMany({
                    where: Object.assign({ createdAt: { gte: yield this.getActiveSessionStartTime() }, orderType: types_1.OrderType.HOMEDELIVERY, orderStatus: { not: types_1.OrderStatus.CANCELLED }, deliveryUserId: { not: null } }, (user.isHomeDeliveryUser && { deliveryUserId: user.id })),
                    include: { customer: true, user: true },
                });
            }
            catch (error) {
    ...
    getTotalOrderCountAndTotalAmoutByDeliveryUser(user) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
...
const feature_auth_1 = __webpack_require__(15);
const data_access_db_1 = __webpack_require__(7);
const order_history_controller_1 = __webpack_require__(154);
const order_history_service_1 = __webpack_require__(155);
...
let OrderHistoryService = class OrderHistoryService {
    ...
    getOrderHistoryOfTheCurrentSession(user, params) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const activeSessionDate = yield this.getActiveSessionStartTime();
            return yield this.getOrderHisotryOfGivenPeriod(activeSessionDate, new Date(), user, params);
        });
    }
    getOrderHisotryOfGivenPeriod(startDateTime, endDateTime, user, params) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            try {
                if (!skip) {
                    ...
                    return this.prismaService.order.findMany({
                        take,
                        where: Object.assign({}, (!user.isCashier && { createdUserId: user.id })),
                        include: { customer: true, user: true },
                    ...
                    return this.prismaService.order.findMany({
                        skip,
                        take,
                        where: Object.assign({ paymentStatus: { in: [types_1.PaymentStatus.CREDIT, types_1.PaymentStatus.PAID] } }, (!user.isCashier && { createdUserId: user.id })),
                        orderBy: { createdAt: 'desc' },
                        include: { customer: true, user: true },
                    });
                }
    ...
    getOrderHistoryOfGivenUserInTheCurrentSession(userId, params) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const activeSessionDate = yield this.getActiveSessionStartTime();
            return this.getOrderHistoryOfGivenPeriodOfAUser(activeSessionDate, new Date(), userId, params);
        });
    }
    getOrderHistoryOfGivenPeriodOfAUser(startDateTime, endDateTime, userId, params) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            // eslint-disable-next-line prefer-const
            let { skip, take } = params;
            if (!take)
            ...
            try {
                if (!skip) {
                    ...
                    const orders = yield this.prismaService.order.findMany({
                        take,
                        where: {
    ...
    getOrderHistoryOfOrderNumberAsArr(orderNumber) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                return this.prismaService.order.findMany({
                    where: { orderNumber },
...
const data_access_db_1 = __webpack_require__(7);
const common_1 = __webpack_require__(2);
const kot_controller_1 = __webpack_require__(158);
const kot_services_1 = __webpack_require__(159);
...
let KotService = class KotService {
    ...
    completeKot(id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                const updatedKot = yield this.prismaService.kot.update({
                    where: {
                        id,
                    },
                    data: {
    ...
    getOpenKots() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const rawQueryResult = yield this.prismaService.$queryRaw `
  select 
...
from	
    ...
    `;
            ...
            rawQueryResult.forEach((result) => {
                ...
                kotMap[kotid] = Object.assign(Object.assign({}, (kotMap[kotid] || {})), Object.assign(Object.assign({}, result), { note: result.kotNote, kotItems: kotMap[kotid]
                        ? [
...
const tslib_1 = __webpack_require__(1);
const common_1 = __webpack_require__(2);
const feature_payment_controller_1 = __webpack_require__(162);
const feature_payment_service_1 = __webpack_require__(164);
const data_access_db_1 = __webpack_require__(7);
const feature_order_1 = __webpack_require__(38);
...
const tslib_1 = __webpack_require__(1);
const common_1 = __webpack_require__(2);
const add_payment_dto_1 = __webpack_require__(163);
const feature_payment_service_1 = __webpack_require__(164);
...
let PaymentService = class PaymentService {
    ...
    getPaymentOptions() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const options = yield this.prismaService.paymentType.findMany();
            return options;
        });
    }
    payTheOrder(addPaymentDto) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const newPayEntry = payments.map((_a) => {
                var { isSelected, name } = _a, item = tslib_1.__rest(_a, ["isSelected", "name"]);
                if (item.paymentTypeId == 1) {
                    return Object.assign(Object.assign({}, item), { amount: item.amount - payedDifference, orderId });
                }
                else {
                    return Object.assign(Object.assign({}, item), { orderId });
                }
            });
            try {
                ...
                yield this.prismaService.payments.createMany({
                    data: [...newPayEntry],
                });
...
const feature_image_upload_controller_1 = __webpack_require__(168);
const data_access_db_1 = __webpack_require__(7);
...
let UploadService = class UploadService {
    ...
    deleteExistingFile(productId) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            //TODO - first read db for existing image file, if existing delete it before saving new.
            const { image: imageUrl } = yield this.prismaService.product.findFirstOrThrow({
                where: { id: productId },
                select: { image: true },
            });
            if (imageUrl) {
    ...
    updateProductImageURL(productId, imageURL) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this.prismaService.product.update({
                where: { id: productId },
                data: { image: imageURL },
            });
        });
...
const tslib_1 = __webpack_require__(1);
const common_1 = __webpack_require__(2);
const platform_express_1 = __webpack_require__(169);
const upload_service_1 = __webpack_require__(167);
let UploadController = class UploadController {
    ...
    uploadImage(file, id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            yield this.uploadService.deleteExistingFile(productId);
            // Process & Save Image
            const imageUrl = yield this.uploadService.processAndSaveImage(file);
            if (imageUrl) {
                yield this.uploadService.updateProductImageURL(productId, imageUrl);
            }
...
const express_1 = __webpack_require__(170);
const path_1 = __webpack_require__(79);
function bootstrap() {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
